    ...
    case "native_provider_catalog_refresh":
      return {
        providers: [
          ...
          { id: "devin", label: "Devin.ai", status: "setup_required", credentialOwner: "user", configured: false, localOnly: false, detail: "Configure credentials", authMethod: "api_key", apiKeyUrl: "https://app.devin.ai/settings/api-keys", modelCount: 1, lastSyncedAt: 1_800_000_000, source: "bundled", error: null },
          { id: "google", label: "Google Gemini", status: "setup_required", credentialOwner: "user", configured: false, localOnly: false, detail: "Configure credentials", authMethod: "api_key", apiKeyUrl: "https://aistudio.google.com/apikey", modelCount: 1, lastSyncedAt: 1_800_000_000, source: "bundled", error: null },
          { id: "groq", label: "Groq", status: "setup_required", credentialOwner: "user", configured: false, localOnly: false, detail: "Configure credentials", authMethod: "api_key", apiKeyUrl: "https://console.groq.com/keys", modelCount: 1, lastSyncedAt: 1_800_000_000, source: "bundled", error: null },
          { id: "openrouter", label: "OpenRouter", status: "setup_required", credentialOwner: "user", configured: false, localOnly: false, detail: "Configure credentials", authMethod: "api_key", apiKeyUrl: "https://openrouter.ai/keys", modelCount: 1, lastSyncedAt: 1_800_000_000, source: "bundled", error: null },

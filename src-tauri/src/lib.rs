...
use commands::{
    ...
    plan_runs::{
        ...
        plan_run_enqueue, plan_run_get, plan_run_list, plan_run_list_queue, plan_run_pause,
        plan_run_remove, plan_run_reorder, plan_run_start, plan_run_start_omp,
    },
    plan_import::{plan_import_apply, plan_import_detect},
    openspec::{
        openspec_archive_change, openspec_derive_change_name, openspec_list_changes,
        openspec_parse_task_progress, openspec_parse_tasks_structured,
        openspec_read_tasks_structured, openspec_resolve_change_name, openspec_task_progress,
...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            native_provider_omp_login_command,

        ...
        let providers = provider_specs()
            ...
            .map(|spec| {
                ...
                NativeProvider {
                    ...
                    supports_web_login: spec.supports_web_login,
...
fn bundled_models(provider_id: &str) -> Vec<NativeModel> {
    match provider_id {
        ...
        "umans" => vec![bundled_provider_model("umans", "umans-glm-5.2", "Umans GLM 5.2")],
        "openai" => vec![bundled_provider_model("openai", "gpt-5.1", "GPT-5.1")],
        "anthropic" => vec![bundled_provider_model("anthropic", "claude-sonnet-4.5", "Claude Sonnet 4.5")],
        _ => Vec::new(),
    }
}

fn bundled_provider_model(provider_id: &str, id: &str, label: &str) -> NativeModel {
